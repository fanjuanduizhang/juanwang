...
-- ----------------------------
BEGIN;
INSERT INTO t_sys_info VALUES ('1', '卷王', '做更好的调查问卷系统', NULL, 'zh-CN', '{}', NULL, NULL, '{"registerEnabled":true,"roles":["1462366121347792897"],"strongPasswordEnabled":false}', 1, '2022-02-11 10:13:19', NULL, '2022-02-11 14:29:03', NULL);
COMMIT;
